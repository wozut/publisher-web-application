...
import {safeReadFile} from "@/libraries/safeReadFile";
...
export default async function ArticleView(article: Article) {
    ...
    const result: ResultAsync<string | Buffer<ArrayBufferLike>, AnyCustomError> = safeReadFile(fullArticlePath, {encoding: "utf8"})
